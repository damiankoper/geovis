...
\begin{samepage}
    ...
    \begin{itemize}
        ...
        \item \texttt{meta} - obiekt typu \texttt{VisualizationMeta} przechowujący informacje o wizualizacji widoczne w panelu kontrolnym aplikacji i dostępnym z zewnątrz,
        ...
        \item \texttt{update} - metoda wywoływana przy co każdą klatkę animacji, służy do aktualizacji obiektów wizualizacji,
        ...
        \item \texttt{\_setupMeta} - metoda wywoływana wewnętrznie obsługująca ustawianie metadanych dla wizualizacji razem z jej rodzicami,
        \item \texttt{\_setup} - metoda wywoływana wewnętrznie dla całego drzewa wizualizacji, odpowiedzialna wywołanie metod \texttt{setupCamera} i \texttt{setupScene},
...
%TODO cykl życia + wstęp - mając już wszystko omówione możemy prześledzić blabla...
